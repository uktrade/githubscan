...
class GeskoReport(Report):
    ...
    def getTeamReport(self):
        ...
        for team in teams:
            team_report = self.__format_gecko_report__(repositories_of_interest=self.getTeamReportRepos(team=team),teams=team)
    ...
    def __format_gecko_report__(self,repositories_of_interest,teams=None):
        ...
        report_repositories = self.db_client.getSortedVunrableRepos(repositories=repositories_of_interest)[:20]
