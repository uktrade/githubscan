# -*- coding: utf-8 -*-
def test_add_orphan_repositories_totals_slo_breaches(
    ...
    check_orphan_repositories_totals_slo_breaches(
        ...
        slo_breach=processor.orphan_repositories["total"]["slo_breach"],
    )

    processor.clear()


def check_orphan_repositories_totals_slo_breaches(scene_index, slo_breach):
    """
    ...
    if scene_index == 8 or scene_index == 7:
