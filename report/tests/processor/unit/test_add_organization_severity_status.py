...
def test_add_organization_severity_status(processor, scene_index, scene_data):
    ...
    check_organization_severity_status(
        ...
        severity_status=processor.processed_data["severity_status"],
    )

    processor.clear()


def check_organization_severity_status(scene_index, severity_status):
