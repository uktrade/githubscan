...
def test_add_skip_scan_repositories_severity_status(processor, scene_index, scene_data):
    """
    ...
    check_skip_scan_repositories_severity_status(
        ...
        severity_status=processor.skip_scan_repositories["severity_status"],
    )

    processor.clear()


def check_skip_scan_repositories_severity_status(scene_index, severity_status):
